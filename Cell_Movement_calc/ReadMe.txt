================================================================================
 MICROSOFT FOUNDATION CLASS-BIBLIOTHEK: Cell_Movement_calc-Projektübersicht
================================================================================

Der Anwendungs-Assistent hat diese Cell_Movement_calc-Anwendung für Sie 
...
finden, aus denen Ihre Cell_Movement_calc–Anwendung besteht.

Cell_Movement_calc.vcxproj
...
Cell_Movement_calc.vcxproj.filters
...
Cell_Movement_calc.h
    ...
    die CCell_Movement_calcApp-Anwendungsklasse.

Cell_Movement_calc.cpp
    Dies ist die Hauptquelldatei der Anwendung, die die CCell_Movement_calcApp-
    Anwendungsklasse enthält.

Cell_Movement_calc.rc
...
res\Cell_Movement_calc.ico
    Dies ist eine Symboldatei, die als Symbol der Anwendung verwendet wird. 
    Dieses Symbol ist in der Hauptressourcendatei "Cell_Movement_calc.rc" 
    enthalten.

res\Cell_Movement_calc.rc2
...
Cell_Movement_calcDlg.h, Cell_Movement_calcDlg.cpp – das Dialogfeld
    Diese Dateien enthalten Ihre CCell_Movement_calcDlg–Klasse. Diese Klasse 
    bestimmt das Verhalten des Hauptdialogfelds Ihrer Anwendung. Die Vorlage des 
    Dialogfelds befindet sich in der Datei "Cell_Movement_calc.rc", die in 
...
"StdAfx.h", "StdAfx.cpp"
    ...
    (PCH-Datei) mit dem Namen "Cell_Movement_calc.pch.pch2 und eine 
...
Wenn Ihre Anwendung MFC in einer freigegleveln DLL verwendet, müssen Sie die 
